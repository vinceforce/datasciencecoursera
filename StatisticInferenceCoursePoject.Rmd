...
# Note on Rmd code
Some R code chunks have been masked for better presentation (including multiplot and spf function declarations).

Complete Rmd code can be found here : [https://github.com]